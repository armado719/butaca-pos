  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans relative overflow-hidden">
      <div
        ...
        style={{
          backgroundImage:
            'url("https://images.unsplash.com/photo-1556910110-ad52744adccb?auto=format&fit=crop&q=80&w=2000")',
              ...
              >
                ...
                <div className="flex-1 p-4 space-y-2">
                  {pedido.productos?.map((prod, i) => (
                    <div
                      key={i}
                      className="flex items-start gap-3 pb-2 border-b border-gray-50 last:border-0"
                    >
