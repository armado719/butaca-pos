        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-2">
              <label className="block text-sm font-black text-gray-800 uppercase tracking-wider ml-1">Usuario / Correo</label>
              <div className="flex items-center bg-gray-50 border-2 border-gray-200 rounded-2xl focus-within:border-[#B5201E] focus-within:bg-white transition-all shadow-sm">
                <div className="pl-4 text-gray-700"><User size={22} /></div>
                <input
                  type="email" value={email} onChange={e => setEmail(e.target.value)}
                  className="w-full px-4 py-4 bg-transparent text-gray-900 font-bold focus:outline-none placeholder-gray-400"
                  placeholder="admin@labutaca.com" required
                />
              </div>
            </div>

            <div className="space-y-2">
              <label className="block text-sm font-black text-gray-800 uppercase tracking-wider ml-1">Contraseña</label>
              <div className="flex items-center bg-gray-50 border-2 border-gray-200 rounded-2xl focus-within:border-[#B5201E] focus-within:bg-white transition-all shadow-sm">
                <div className="pl-4 text-gray-700"><Lock size={22} /></div>
                <input
          ...
          <div className="mt-16 pt-8 border-t border-gray-100 flex flex-col items-center">
            <p className="text-gray-400 text-[11px] font-bold uppercase tracking-[0.3em] mb-1">La Butaca Restaurante</p>
            <p className="text-gray-300 text-[9px] font-medium italic">"La comida de siempre, la tecnología de hoy"</p>
          </div>
        </div>
      </div>
    </div>
